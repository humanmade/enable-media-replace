...
<div class="wrap">
	...
	<form enctype="multipart/form-data" method="post" action="<?php echo $formurl; ?>">
		...
		<div id="message" class="updated fade">
			<p><?php echo __( "NOTE: You are about to replace the media file", "enable-media-replace" ); ?>
				"<?php echo $current_filename ?>
				". <?php echo __( "There is no undo. Think about it!", "enable-media-replace" ); ?></p></div>
		...
		<?php if ( apply_filters( 'emr_display_replace_type_options', true ) ) : ?>
			...
			<label for="replace_type_1"><input CHECKED id="replace_type_1" type="radio" name="replace_type" value="replace"> <?php echo __( "Just replace the file", "enable-media-replace" ); ?>
			</label>
